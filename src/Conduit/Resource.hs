      ...
      body_ $ do
        ...
        nav_ [class_ "navbar navbar-light", hxBoost_ "true", hxTarget_ "#content-slot", hxPushUrlSafe_ (Left True)] $
          div_ [class_ "container"] $ do
            a_ [class_ "navbar-brand", hxGetSafe_ homeLink, href_ ""] "conduit"
            ul_ [class_ "nav navbar-nav pull-xs-right"] $ do
              li_ [class_ "nav-item"] $
                a_ [class_ "nav-link active", hxGetSafe_ homeLink, href_ ""] "Home"
              li_ [class_ "nav-item"] $
              ...
              li_ [class_ "nav-item"] $
                a_ [class_ "nav-link", href_ ""] $ do
                  ...
                  "Settings"
              li_ [class_ "nav-item"] $ a_ [class_ "nav-link", hxGetSafe_ signInFormLink, href_ ""] "Sign in"
              li_ [class_ "nav-item"] $ a_ [class_ "nav-link", hxGetSafe_ signUpFormLink, href_ ""] "Sign up"
        -- NAVBAR END
...
type SignUpFormSubmitRoute =
    ...
    :> Post '[HTML] (Headers '[Header "Set-Cookie" SetCookie, Header "Set-Cookie" SetCookie] Profile)
...
type ProtectedRoutes = Get '[HTML] Profile
